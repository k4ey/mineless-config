...
if width <= 50 or depth <= 50 then
	toast("&c&B[MOLEBOT]", "Your mine is to small!")
end
assert(width >= 50, "&cRequired size: &B 50 blocks. &cYou got &a&B" .. width .. ". &c Use &Bvertical.lua &f")
assert(depth >= 50, "&cRequired size: &B 50 blocks. &cYou got &a&B" .. depth .. ". &c Use &Bvertical.lua &f")
